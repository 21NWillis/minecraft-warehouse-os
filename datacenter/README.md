...
**Datacenter Terminal** (crafted from iron, redstone, and an ender pearl),
which is a 9-slot inventory + a `datacenter` peripheral for CC: Tweaked.
...
```lua
local dc = peripheral.find("datacenter")
-- producer
...
Jar lands in `build/libs/datacenter-0.1.0.jar`. Test in a singleplayer world
